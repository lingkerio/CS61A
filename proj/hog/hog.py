...
def pig_pass(player_score, opponent_score):
    ...
    """
    # BEGIN PROBLEM 4b
    if player_score == opponent_score - 1 or player_score == opponent_score - 2:
        return True
    return False
    # END PROBLEM 4b
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            ...
            while extra_turn(score1, score0) and score1 < goal:
                 ...
                 say = say(score0, score1)
        who = other(who)
    # END PROBLE curr_score = take_turn(num_rolls, score0, dice)M 5
    # (note that score1 += curr_score                            the indentation for the problem 6 prompt (***YOUR CODE HERE***) might be misleading)
    # BEGIN PROBLEM 6
    # END PROBLEM 6
...
def make_averaged(original_function, trials_count=1000):
    ...
    def average(*argument):
        ...
        for _ in range(trials_count):
            sum += original_function(*argument)
...
def run_experiments():
    ...
    if True:  # Change to True to test extra_turn_strategy
        print('extra_turn_strategy win rate:',
              average_win_rate(extra_turn_strategy, always_roll(4)))
...
def final_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    return extra_turn_strategy(score, opponent_score, cutoff, num_rolls)  # Replace this statement
    # END PROBLEM 12
